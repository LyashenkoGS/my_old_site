...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resources/Games/Shooter/style/shooter.css">
...
bottom: -15px;
left: 50%;
transform: translate(-50%, 0px);"><img id="gunImg"
                                       src="${pageContext.request.contextPath}/resources/Games/Shooter/shooterImg/gun.png">
</div>
